...
const DefaultNavbar: React.FC<propType> = (props) => {
    const { onDrawerClick } = props
    return (
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50" suppressHydrationWarning>
            <div className="flex flex-wrap justify-between items-center">
                <div className="flex justify-start items-center">
                    ...
                    <a href="#/admin/dashboard" >
                        <Image height={60} width={60} src="/rjs-logo.png" alt="image description" />
                    </a>
