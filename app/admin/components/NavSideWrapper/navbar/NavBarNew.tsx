...
export default function NavbarWithDropdown({ onDrawerClick,user }: propType) {    
    return (
        ...
        <Navbar className="bg-white no-print  border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50"  fluid rounded>
            <button
