...
export const priceSchema = z.object({
  ...
  clientTypeId: z.string({required_error:'Client type is required',invalid_type_error:'Invalid Client type'}),
  productId: z.string({required_error:'Product is required',invalid_type_error:'Invalid Product type'}),
});
